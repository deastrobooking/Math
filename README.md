...
1. **Indefinite Integrals** – Represented as ∫f(x)dx, it gives a family of functions (antiderivative) plus a constant of integration (C).
2. **Definite Integrals** – Represented as ∫[a, b] f(x)dx, it computes the exact area under a curve between limits **a** and **b**.
